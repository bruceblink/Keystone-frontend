...
import type { LaserForm, ComboxOption } from "../utils/types";
...
const form = defineModel<LaserForm>("form", { required: true });
const visible = defineModel<boolean>("visible");
const emit = defineEmits<{ submit: [form: LaserForm] }>();
...
<template>
  <el-drawer
    v-model="visible"
    :title="mode === 'add' ? '添加激光设备' : '编辑激光设备'"
    direction="rtl"
    size="520px"
    destroy-on-close
  >
    <el-form ref="formRef" :model="form" :rules="formRules" label-width="100px">
      <el-form-item label="设备编号" prop="camid">
        <el-input
          v-model="form.camid"
          placeholder="请输入设备编号"
          maxlength="64"
